...
import { SIDEBAR_CONFIG, type SidebarNavItem } from "~/src/app/[locale]/(admin)/admin/_lib/sidebar"
 ...
 */
function CommandDestination({ item, label, onNavigate }: CommandDestinationProps): JSX.Element {
