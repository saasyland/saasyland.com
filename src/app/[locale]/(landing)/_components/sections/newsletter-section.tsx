  ...
  return (
    <section className="relative z-10 mx-auto max-w-7xl px-6 py-16 md:py-24">
      <div className="relative flex flex-col items-center overflow-hidden rounded-[3rem] border border-border/50 bg-background/80 p-10 text-center backdrop-blur-md md:p-20">
        ...
        <h2 className="relative z-10 mb-4 text-3xl font-medium tracking-tight text-foreground md:text-5xl">{t("title")}</h2>
        ...
        <form className="relative z-10 flex w-full max-w-md flex-col gap-4 sm:flex-row">
          ...
          <Button
            type="button"
            className="h-12 rounded-xl bg-linear-to-b from-primary to-primary/80 px-6 whitespace-nowrap text-primary-foreground shadow-[0_0_15px_-3px_var(--color-primary)] transition-all hover:opacity-90"
          >
            {t("button")}
          </Button>
        </form>
