  ...
  "pages": {
    ...
    "landing": {
      ...
      "proof": {
        "facts": {
          ...
          "tests": {
            "label": "Test files",
            "value": "141",
            "note": "Unit, integration and 5 Playwright suites in real browsers."
          },
          "types": {
            "label": "Type safety",
            "value": "Strict",
      ...
      "line": {
        ...
        "stations": {
          ...
          "tests": {
            ...
            "body": "Not vibe-coded on a weekend. 141 test files and 5 Playwright suites run on every pull request, and the coverage gate fails the build before anything broken can merge. Deploy on a Friday and actually take the weekend.",
      ...
      "quality": {
        ...
        "body": "Every unit, integration and end-to-end path is covered before it merges. 141 test files, 5 Playwright suites in real Chromium and WebKit, and a coverage gate that runs on every pull request and every push to main.",
      ...
      "manifest": {
        ...
        "items": {
          ...
          "tests": {
            "label": "Tests",
            "body": "141 unit and integration test files, 5 Playwright suites, and 100% statement, branch, function and line coverage enforced as a gate in CI."
          },
          "tooling": {
            "label": "Tooling",
      ...
      "pricing": {
        ...
        "ledger": {
          ...
          "body": "Price it in your own hours. At $150 an hour, $249 is under two hours of your time. The work it replaces is not two hours. It is auth with two-factor and OAuth, a typed data layer, billing with webhooks, transactional email, ten admin sections, a 54-locale i18n layer and a test suite that actually gates the build. Every one of those is a solved problem you would solve again, and not one of them is the reason anybody will pay you."
        },
        ...
        "tiers": {
          "core": {
            ...
            "price": "$249",
            "period": "one-time",
            "tagline": "The CLI, the source and the tests.",
      ...
      "faq": {
        ...
        "items": {
          "q1": {
            ...
            "answer": "The full source of a production SaaS: Next.js, React, Bun, Elysia, Better Auth, Drizzle with Neon Postgres, Stripe, Resend and next-intl. You also get CLI scaffolding, the complete test suite, the visual page designer and documentation. The Complete and Agency tiers add the video course, commercial licensing and the Figma files."
          },
          "q2": {
          ...
          "q9": {
            ...
            "answer": "Core and Complete cover unlimited products you own. Building for clients is what the Agency tier is for: one license, unlimited client projects."
          },
          "q10": {
      ...
      "gate": {
        ...
        "assurance": "Pay once, run the CLI, own every line. No subscription, no per-user fees, and no vendor to migrate off in year two.",
        "ctaPrimary": "Start building",
