...
import { type ValidationNamespace, translateValidationMessage } from "~/src/integrations/use-intl/validation-messages"

import { FieldError } from "~/src/presentation/components/shadcn/field"

interface ValidationFieldErrorProps {
  readonly message?: string | undefined
  readonly namespace: ValidationNamespace
...
export const ValidationFieldError = ({ message, namespace, paramsByKey }: ValidationFieldErrorProps): JSX.Element | undefined => {
  ...
  return <FieldError>{translateValidationMessage({ message, namespace }, t, paramsByKey)}</FieldError>
}
