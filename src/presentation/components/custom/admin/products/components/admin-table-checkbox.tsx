...
export const AdminTableCheckbox = ({ selectAll = false }: Readonly<AdminTableCheckboxProps>): JSX.Element => (
  <input type="checkbox" aria-label={selectAll ? "Select all rows" : "Select row"} className={ADMIN_TABLE_CHECKBOX_CLASS} />
)
