 ...
 */
async function play(video: HTMLVideoElement, offsetSeconds: number): Promise<void> {
  try {
...
export function ConceptLoop({ className, label, name, offsetSeconds = 0 }: ConceptLoopProps): JSX.Element {
