...
_Written by Piotr J. Borowiecki, who builds SaaSyLand. The Next.js warning quoted at the top is generated into this repository's own `AGENTS.md` by `next dev`, not written by hand._
