...
import { CopyButton } from "~/src/app/[locale]/(landing)/_components/shared/copy-button"
import { RunnerTabs } from "~/src/app/[locale]/(landing)/_components/shared/runner-tabs"
import {
  CLI_CHOICES,
  CLI_EXTRAS,
  CLI_MODULES,
  ...
  SCAFFOLD_DIR,
  SCAFFOLD_TARGET,
} from "~/src/app/[locale]/(landing)/_lib/cli-choices"
import { EXP, EXP_FAST, PRESS, TAP } from "~/src/app/[locale]/(landing)/_lib/motion-tokens"
