...
const DrawerTrigger = ({ ...props }: DrawerPrimitive.Trigger.Props) => <DrawerPrimitive.Trigger data-slot="drawer-trigger" {...props} />

const DrawerPortal = ({ ...props }: DrawerPrimitive.Portal.Props) => <DrawerPrimitive.Portal data-slot="drawer-portal" {...props} />
...
const DrawerFooter = ({ className, ...props }: ComponentProps<"div">) => (
  <div data-slot="drawer-footer" className={cn("mt-auto flex shrink-0 flex-col gap-2 p-4 pt-0", className)} {...props} />
)
