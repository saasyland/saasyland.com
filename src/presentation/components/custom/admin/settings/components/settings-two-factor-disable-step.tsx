...
export const SettingsTwoFactorDisableStep = ({ onDisabled }: Readonly<SettingsTwoFactorDisableStepProps>): JSX.Element => {
  const queryClient = useQueryClient()
  const disableTwoFactorRequest = useMutation({
  ...
  const passwordForm = useForm({
    ...
    validators: { onChange: disableTwoFactorSchema, onSubmit: disableTwoFactorSchema },
  })
  ...
  return (
    ...
    >
      ...
      <Button className="gap-2" isDisabled={isPending} type="submit" variant="destructive">
