...
export const RegionProgressBar = ({ percentage }: RegionProgressBarProps): JSX.Element => (
  <div className="h-full rounded-full bg-primary" style={REGION_WIDTH_STYLES[percentage]} />
)
