  ...
  return (
    <section className="relative z-10 mx-auto flex max-w-5xl flex-col items-center px-6 pt-48 pb-24 text-center">
      <Link
        ...
        className="mb-10 inline-flex items-center gap-2 rounded-full border border-border/50 bg-background/50 px-4 py-1.5 font-medium text-muted-foreground text-xs backdrop-blur-md transition-colors hover:bg-white/5"
      >
      ...
      <h1 className="mb-8 max-w-4xl font-bold text-6xl text-foreground leading-[1.05] tracking-tighter sm:text-7xl lg:text-8xl">
        {t("titlePart1")}
        <span className="bg-linear-to-r from-primary via-primary/80 to-primary/60 bg-clip-text text-transparent">{t("titlePart2")}</span>
      </h1>

      <p className="mb-12 max-w-2xl font-normal text-lg text-muted-foreground leading-relaxed md:text-xl">{t("description")}</p>
