...
const AlertDialogTrigger = ({ ...props }: Readonly<AlertDialogTriggerPrimitiveProps>) => (
...
const AlertDialogContent = (props: ComponentProps<typeof AlertDialog>) => <AlertDialog {...props} />
...
const AlertDialogTitle = ({ className, ...props }: Readonly<Omit<ComponentProps<typeof Heading>, "slot">>) => (
  <Heading
    slot="title"
...
const AlertDialogDescription = ({ className, ...props }: Readonly<Omit<ComponentProps<"div">, "slot">>) => (
  <div
...
const AlertDialogCancel = ({ className, variant = "outline", size = "default", ...props }: ComponentProps<typeof Button>) => (
  <Button slot="close" data-slot="alert-dialog-cancel" className={cn(className)} variant={variant} size={size} {...props} />
)
