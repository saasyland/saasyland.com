...
faq:
  ...
  - question: What does "architecture enforced by the linter" actually mean?
    answer: >-
      That the boundaries are executable rather than described. In this codebase, domain code cannot
      import React, Next, Drizzle or infrastructure; application code cannot import infrastructure;
      presentation code cannot import the ORM. Those are lint rules that fail the build, so an
      architectural violation is a red check rather than a paragraph in a readme nobody reads.
