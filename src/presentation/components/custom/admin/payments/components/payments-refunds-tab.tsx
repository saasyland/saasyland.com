...
import { PaymentsRefundRow } from "~/src/presentation/components/custom/admin/payments/components/payments-refund-row"
import { PaymentsRefundStatCard } from "~/src/presentation/components/custom/admin/payments/components/payments-refund-stat-card"
import { PaymentsRefundsTableHead } from "~/src/presentation/components/custom/admin/payments/components/payments-refunds-table-head"
import { PaymentsRefundsTablePagination } from "~/src/presentation/components/custom/admin/payments/components/payments-refunds-table-pagination"
...
export const PaymentsRefundsTab = ({ paymentRows }: PaymentsRefundsTabProps): JSX.Element => {
