...
function NativeSelectOption({ className, ...props }: ComponentProps<"option">): JSX.Element {
  return <option data-slot="native-select-option" className={cn("bg-[Canvas] text-[CanvasText]", className)} {...props} />
}

function NativeSelectOptGroup({ className, ...props }: ComponentProps<"optgroup">): JSX.Element {
