...
const Tabs = ({ className, ...props }: Omit<TabsProps, "className"> & { className?: string }) => (
  <TabsPrimitive className={cn("group/tabs flex gap-2 data-horizontal:flex-col", className)} data-slot="tabs" {...props} />
)
...
const TabsList = ({ className, variant = "default", ...props }: TabListProps<object> & VariantProps<typeof tabsListVariants>) => (
  <TabListPrimitive className={cn(tabsListVariants({ variant }), className)} data-slot="tabs-list" data-variant={variant} {...props} />
)

const TabsTrigger = ({ className, ...props }: Omit<TabProps, "className"> & { className?: string }) => (
  <TabPrimitive
    className={cn(
...
const TabsContent = ({ className, ...props }: Omit<TabPanelProps, "className"> & { className?: string }) => (
  <TabPanelPrimitive className={cn("flex-1 text-sm outline-none", className)} data-slot="tabs-content" {...props} />
)
