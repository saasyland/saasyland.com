...
export const ProductsTaggedRow = ({ product }: ProductsTaggedRowProps): JSX.Element => (
  <tr className="group transition-colors hover:bg-muted/40">
    ...
    <td className="p-4 pt-5 align-top text-sm text-muted-foreground">{METRICS_PLACEHOLDER}</td>
