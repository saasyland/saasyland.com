...
| -------------------------- | :---: | -------------------------------------------------------------------------------------- |
| 1. Instruction file        |   2   | `AGENTS.md` at the root, plus per-area files, all naming commands CI runs              |
...
| 4. One command             |   2   | `bun run verify`                                                                       |
| 5. Coverage as a gate      |   2   | 100% statements, branches, functions and lines, enforced in `.github/workflows/ci.yml` |
| 6. Real browsers           |   2   | 5 Playwright suites on Chromium and WebKit                                             |
| 7. Zero-tolerance types    |   2   | `tsc --strict` blocks the merge on one error                                           |
| 8. Enforced boundaries     |   2   | Layer rules fail the build, not the review                                             |
| 9. Protected surfaces      |   2   | Migrations, secrets and webhooks marked human-review-only                              |
