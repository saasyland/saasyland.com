...
vi.mock("~/src/modules/account/use-cases/sign-out-user", () => ({ settingsSignOutUserMutation: { mutationFn: signOut } }))

const messages = getTestMessages("en-US")
const labels = messages.pages.admin.components.signOutButton
