...
vi.mock(import("~/src/presentation/components/shadcn/toggle-group"), async (importOriginal): Promise<Partial<typeof ShadcnToggleGroup>> => {
  ...
  function ToggleGroup(props: ComponentProps<typeof actual.ToggleGroup>) {
    if (props.onSelectionChange !== undefined) {
      rowDensityChangeHandler.current = props.onSelectionChange
    }
