...
_Ostatnia aktualizacja: 15 sierpnia 2026. To druga część serii; pierwsza opisuje, [dlaczego to repozytorium decyduje o jakości pracy agenta](/blog/ai-coding-agents-repository-readiness), i warto zacząć od niej._
...
[Dokumentacja](/docs) jest publiczna, a raport pokrycia generuje samo repozytorium. Potem [zobacz, ile to kosztuje](/#pricing): jedna płatność od 249 dolarów, dożywotnie aktualizacje rdzenia, bez opłat za użytkownika.
