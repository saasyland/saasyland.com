...
export type SelectComponentProps<T extends object, M extends "single" | "multiple" = "single"> = Omit<SelectProps<T, M>, "children"> & {
  children?: ReactNode
  fieldLabel?: ReactNode
  fieldLabelClassName?: string
}

function shouldRenderSelectFieldLabel(fieldLabel: ReactNode | undefined): fieldLabel is Exclude<ReactNode, undefined | false | ""> {
  return fieldLabel !== undefined && fieldLabel !== false && fieldLabel !== ""
}
...
function Select<T extends object, M extends "single" | "multiple" = "single">({
  ...
  fieldLabelClassName,
  ...props
}: Readonly<SelectComponentProps<T, M>>) {
  return (
...
function SelectItem<T extends object>({ children, className, textValue, ...props }: Readonly<ListBoxItemProps<T>>) {
