...
function RadioGroup({ className, ...props }: Readonly<RadioGroupPrimitive.Props>): JSX.Element {
  return <RadioGroupPrimitive data-slot="radio-group" className={cn("grid w-full gap-2", className)} {...props} />
}

function RadioGroupItem({ className, ...props }: Readonly<RadioPrimitive.Root.Props>): JSX.Element {
  return (
    <RadioPrimitive.Root
